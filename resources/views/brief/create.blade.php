...
@section('content')
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url("/brief-create") }}" class="form-horizontal breifForm" method="post">
                {{ csrf_field() }}
                <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input name="eventBaslangicTarihi" type="text"
                               ...
                               value="{{ old('eventBaslangicTarihi') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="kisiSayisi"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="projeEvSahibiProfili"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                name="katlımcıProfiliHedefKitle"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="kadınErkekDağılımıYüzde"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="projeMekan"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="isTanimi"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="amac"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="Konsepti giriniz" class="form-control" name="konsept"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="icerikGunAkısDetay"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="markaAkreTipi"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="karakteri"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="detaylar"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="butceAraligi"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="butceDagilimi"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="oncekiDonemlerTaihAralıgı">Onceki Donemler Tarih Aralıgı</label>
                    <div class="col-sm-10">
                        <textarea
...
Örneğin; Gala önemli sanatçıya para harcamak toplantıyı daha basit kurguda gerçekleştirmek isteniyor. Yada Toplantı içeriği ve teknolojik yaklaşım daha önemli Galada daha ekonomik bir alternatif olabilir vb. "
                                class="form-control" name="oncekiDonemlerTaihAralıgı"></textarea>
                    </div>
                </div>
                <div class="form-group">
...
Örneğin; Welcome Event, İlk Gün dj Party, Açık Hava, Ana salon, Fuaye vb" class="form-control"
                                name="ozelGeceler"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="sanatciGala">Sanatci Gala</label>
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="sanatciGala"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="konusmaci"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="sunucuModerator"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="sovTeatral"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="acivite"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="serbestZamanİcerikleri"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="markaRenkKodlari"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="markaLogosuFontlariVector"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="markaKurumsakKimlikDokumani"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                placeholder="" class="form-control" name="tasarimsalNetBeklenti"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="2DTasarimKalemleri"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control" name="DekorasyonSusleme"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea
                                ...
                                class="form-control"
                                name="MultiMediaTasarımKalemleri"></textarea>
                    </div>
                </div>
