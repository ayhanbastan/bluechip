...
@section('content')
    <div class="box-body">
        <form id="form" action="{{ url('/kontak-edit/'.$kontak->id) }}" method="post">
                        ...
                        <div class="section row mbn">
                            ...
                            <div class="col-sm-12" style="margin-top: 15px">
                                ...
                                <select id="sirketId" name="sirketId" style="width:100%; margin-top: 15px"
                                    ...
                                    <option value="{{ $kontak->sirketId }}">{{ $kontakName->ad }}</option>
